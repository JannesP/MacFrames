...
robocopy "..\\" "C:\Programs\World of Warcraft\_xptr_\Interface\AddOns\MacFrames" /mir /XF ".*" /XD ".*"
robocopy "..\\" "C:\Programs\World of Warcraft\_beta_\Interface\AddOns\MacFrames" /mir /XF ".*" /XD ".*"